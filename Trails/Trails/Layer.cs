...
namespace Trails
{
    ...
    public class Particle : ILayer
    {
        ...
        const byte SPRITEMODE_DEFAULT = 0;
        const byte SPRITEMODE_ANIMATED = 1;
        const byte SPRITEMODE_RANDOM = 2;
        const byte SPRITEMODE_SEQUENTIAL = 3;
    ...
    public class Animation : ILayer
    {
        ...
        const byte LOOP_LOOP = 0;
        const byte LOOP_PING_PONG = 1;
        const byte LOOP_ONCE_THEN_FREEZE = 2;
        const byte LOOP_ONCE_THEN_DISSAPEAR = 3;
